...
const urlSelection = () => {
  ...
  return {
    ...
    cellType: P14_CELL_TYPES.includes(cellType) ? cellType : '',
  };
};
...
const withUrlSelection = (config) => {
  ...
  return {
    ...config,
    uid: `p14-${feature || 'all'}-${cellType || 'all'}`,
    coordinationSpace: {
  ...
  "datasets": [
    {
      ...
      "files": [
            ...
            "images": [
              {
                ...
                "url": dataUrl("/p14/heart-xenium-raw.zarr/"),
                "type": "zarr",
                "metadata": {
                  "isBitmask": false,
                  "dimensions": [
              ...
              },
              {
                ...
                "url": dataUrl("/p14/heart-xenium-label.zarr/"),
                "type": "zarr",
                "metadata": {
                  "isBitmask": true,
                  "dimensions": [
        ...
        },
        {
          ...
          "url": dataUrl("/p14/heart-xenium-anndata.zarr/"),
          "options": {
            "obsLocations": {
              "path": "obsm/X_spatial"
            },
